...
export default function Departments() {
  return (
    <div className='pt-32 h-fit md:h-fit  md:pt-20 mb-16 '>
        ...
        <div class="w-full max-w-sm rounded-t-xl overflow-hidden shadow-lg border-2 ">
            <img class="w-full object-cover object-center h-64 select-none " src={LogoCME} alt="Sunset in the mountains" draggable={false} />
            <div class="px-6 py-4">
              <div class="font-bold text-xl mb-2 text-black">Computer Science Engineering</div>
          ...
          <div class="w-full max-w-sm rounded-t-xl overflow-hidden shadow-lg border-2">
            <img class="w-full object-cover object-center h-64 select-none " src={LogoECE} alt="Sunset in the mountains" draggable={false} />
            <div class="px-6 py-4">
              <div class="font-bold text-xl mb-2 text-black">Electronics and Communications Engineering</div>
              <p class="text-gray-700 text-base">
          ...
          <div class="w-full max-w-sm rounded-t-xl overflow-hidden shadow-lg border-2">
            <img class="w-full object-cover object-center h-64 select-none " src={LogoMEC} alt="Sunset in the mountains" draggable={false} />
            <div class="px-6 py-4">
              <div class="font-bold text-xl mb-2 text-black">Mechanical Engineering</div>
              <p class="text-gray-700 text-base">
