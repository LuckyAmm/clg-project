...
const navigation = [
  ...
  { name: "Comittie", href: "/about" },
  { name: "Gallery", href: "/gallery" },
  { name: "About", href: "/about" },
  { name: "AICEF", href: "/AICEF" },
  { name: "EOAD", href: "/about" },
];
    ...
    <div className="sticky top-0 left-0 select-none z-10 h-0 w-screen">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link to='/login' className=" flex gap-2 items-center rounded-md bg-indigo-600 px-3.5 py-1.5 text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Log in
        ...
        >
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                <Link to='/login' onClick={() => setMobileMenuOpen(false)} className="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-6 bg-indigo-500 w-fit text-white  hover:bg-indigo-700">
                  Log in
                </Link>
              </div>
            </div>
